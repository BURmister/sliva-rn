...
const ProductCard = ({ product, navigateDetailScreen }) => {
   return (
      <View style={[styles.productCard]}>
         ...
         <View style={styles.productCardContent}>
            ...
            <View style={styles.productNameWrapper}>
               <TouchableOpacity onPress={() => navigateDetailScreen({ id: product.id, title: product.name })}>
                  <Text style={styles.productName}>{trunclateTitle(product.name)}</Text>
               </TouchableOpacity>
            </View>
